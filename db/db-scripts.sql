...
CREATE TABLE `parking_lot` (
  ...
  `minimum_hr_to_pay` char(1) DEFAULT NULL,
  `is_monthly_pass_allow` char(1) DEFAULT NULL,
  `monthly_pass_cost` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `parking_one_time_reservation` (
  ...
  `basic_parking_cost` decimal(10,2) DEFAULT NULL,
  `offer_code` varchar(10) DEFAULT NULL,
...
CREATE TABLE `parking_pricing` (
  ...
  `morning_hr_cost` decimal(10,2) DEFAULT NULL,
  `midday_hr_cost` decimal(10,2) DEFAULT NULL,
  `evening_hr_cost` decimal(10,2) DEFAULT NULL,
  `all_day_cost` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `parking_lot_id` (`parking_lot_id`),
